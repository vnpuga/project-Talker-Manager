...
const talkerControler = require('../controllers/talkerController');

const router = express.Router();

// req1 GET /talker
router.get('/', talkerControler.getAll);

// req8 GET /talker/search?q=searchTerm
router.get('/search', checkAuthorization, talkerControler.getSearch);

// req2 GET /talker/:id
router.get('/:id', talkerControler.getById);

// req5 POST /talker
router.post('/', checkAuthorization, checkName, checkAge, checkTalk,
  checkTalkWatchedAt, checkTalkRate, talkerControler.insert);

// req6 PUT /talker/:id
router.put('/:id', checkAuthorization, checkName, checkAge, checkTalk,
  checkTalkWatchedAt, checkTalkRate, talkerControler.update);

// req7 DELETE /talker/:id
router.delete('/:id', checkAuthorization, talkerControler.remove);

module.exports = router;

// como era a rota antes do msc
